...
#define nrf24_ce_digitalWrite(state) CE24L01=state
/* -------------------------------------------------------------------------- */
/* nrf24 CE pin control function
 *    - state:1 => Pin HIGH
 *    - state:0 => Pin LOW     */
...
#define nrf24_csn_digitalWrite(state) CSN24L01=state
/* -------------------------------------------------------------------------- */
...
#define nrf24_sck_digitalWrite(state) SCK=state
/* -------------------------------------------------------------------------- */
